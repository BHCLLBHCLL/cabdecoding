# P0-1 e2e check: native `all` grid count vs STpre golden 59x118x121,
# using the decoded STpre display-mesh recipe (facet_body_stpre).
import json, sys
...
print("bodies tessellated:", len(tess), "total pts:",
      sum(len(a) for a in tess.values()))
