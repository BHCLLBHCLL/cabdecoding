...
def test_pcle_create_matches_official_layout():
    ...
    assert lines[i:i + 13] == [
        ...
        f"{1.0e-4:29.14e}",
        f"{2.0:29.14e}",
        f"{1.0e3:29.14e}{-1.0:29.14e}{1.0e-4:29.14e}"
        f"{1.0e-1:29.14e}{0:4d}",
        f"{0.0:29.14e}{10.0:29.14e}{3.0e-3:29.14e}",
        f"{100:12d}{1:12d}{0:12d}",
        f"{0:15d}{5.0e-3:29.14e}{5.0e-2:29.14e}{5.0e-2:29.14e}"
        f"{1.0:29.14e}{0.0:29.14e}{0.0:29.14e}",
        f"{50.0:29.14e}{70.0:29.14e}{2.5e-3:29.14e}",
        "    echarge",
        f"{3.0e-11:29.14e}",
        "   /",
    ]
